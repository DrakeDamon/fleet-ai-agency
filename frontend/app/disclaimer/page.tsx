...
export default function DisclaimerPage() {
  return (
    <main className="min-h-screen bg-slate-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-lg border border-slate-200 prose prose-slate">
        <h1 className="text-3xl font-bold text-slate-900 mb-8">Guarantee & Financial Projections Disclaimer</h1>
        ...
        <h2 className="text-xl font-bold text-slate-900 mt-8 mb-4">Performance Guarantee Limitations</h2>
        <p className="mb-6">
        ...
        <h2 className="text-xl font-bold text-slate-900 mt-8 mb-4">Voiding Conditions & Liability Cap</h2>
        <p className="mb-6">
